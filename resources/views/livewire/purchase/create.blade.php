        ...
        <x-slot name="content">
            <div class="grid grid-cols-2 gap-8">
                <div class="mt-4">
                    ...
                    @error('item.purchase_price') <x-tall-crud-error-message>{{$message}}</x-tall-crud-error-message>
                    @enderror
                </div>
                ...
                <div class="mt-4">
                    ...
                    @error('item.quantity') <x-tall-crud-error-message>{{$message}}</x-tall-crud-error-message>
                    @enderror
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-8">
                ...
                <div class="mt-4">
                    ...
                    @enderror
                        ...
                        <x-tall-crud-select :isVisible="false" class="block mt-1 w-full" wire:model.defer="item.product_id" >
                            <option value="">Please Select</option>
                            @foreach($products as $c)
                            <option value="{{$c->id}}">{{$c->name}}</option>
                            @endforeach
