    ...
    <x-tall-crud-dialog-modal wire:model="confirmingItemCreation">
        ...
        <x-slot name="content">
            <div class="mt-4">
                ...
                <x-tall-crud-input class="block mt-1 w-1/2" type="text" wire:model.defer="item.product_id" />
            ...
            <div class="mt-4">
                ...
                <x-tall-crud-input class="block mt-1 w-1/2" type="text" wire:model.defer="item.quantity" />
