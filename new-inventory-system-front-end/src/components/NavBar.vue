...
<div class="flex flex-col">
        <header class="flex justify-between items-center h-16 py-4 px-6 bg-white">
            ...
            <div class="flex items-center" @click="setOpenButton()">
                <button @click="$emit('toggle')"
                ref="openButtonRef"
                    class="openButton text-gray-500 hover:text-primary focus:outline-none lg:hidden transition duration-200">
            ...
            <div class="flex items-center">
                ...
                <div x-data="{ linkActive: false }" class="relative mx-6">
                    ...
                    <!-- start::Submenu -->
                    <div x-show="linkActive" @click.away="linkActive = false"
                        class="absolute right-0 w-96 top-11 border border-gray-300 z-10" style="display: none;">
                ...
                <div x-data="{ linkActive: false }" class="relative">
                    ...
                    <!-- start::Submenu -->
                    <div x-show="linkActive" @click.away="linkActive = false"
                        class="absolute right-0 w-40 top-11 border border-gray-300 z-20" style="display: none;">
                        <!-- start::Submenu content -->
...
const sidebar = document.querySelector('.opdeButton')
...
function logout() {
    ...
    function setOpenButton(){
     ...
     emit('OpenButton',openButtonRef.value)
